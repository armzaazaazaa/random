    ...
    function OrgChart($container, opts) {
        ...
        this.startEdit = function(id) {
            ...
            var commitChange = function() {
                ...
                var dataNode = JSON.stringify(nodes[id]);
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        if (result == 1) {
                            $.post('savenode', { obj: dataNode }, function(res) {
                                console.log(res);
                            });
                        }
                    }
        ...
        this.newNode = function(parentId, level) {
            var nextId = Object.keys(nodes).length;
            while (nextId in nodes) {
                nextId++;
            }
            level += 1;
            self.addNode({ id: nextId, name: '', parent: parentId, level });
        }
        ...
        this.formatNode = function(opts) {
            ...
            if (opts.showControls) {
                ...
                if (self.data.level <= 2) {
                    ...
                    var buttonsHtml = "<div class='org-del-button'></div>";
                }
            } else {
                buttonsHtml = '';
            }
